...
-- =====================================================
-- Grants (tùy chỉnh theo user của bạn)
-- =====================================================
-- CREATE USER IF NOT EXISTS 'ai_vision_user'@'%' IDENTIFIED BY 'your_password_here';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON ai_vision_db.* TO 'ai_vision_user'@'%';
-- FLUSH PRIVILEGES;
...
SELECT CONCAT('Dữ liệu mẫu: ', COUNT(*), ' detections') AS sample_data FROM detections;
